// First screen ever seen on a new device.
// User must enter a valid 16-character code generated by admin.
...
// Code is displayed as XXXX-XXXX-XXXX-XXXX (4 groups of 4)
const GROUP_SIZE = 4
...
export default function AccessCodePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Mark the code as seen (used_at will be set after account creation)
      // Save locally so device doesn't need to check again
                ...
                <div key={i} className="flex items-center gap-2">
                  <input
                    ...
                    className="w-16 h-14 text-center text-white font-mono text-lg font-bold
                               ...
                               tracking-widest uppercase transition-all placeholder-white/20"
                    placeholder="XXXX"
                    autoComplete="off"
                    spellCheck={false}
                  />
