...
<body>
  <div class="page">
    ...
    ${b?`<div class="words">Arr\xeat\xe9 la pr\xe9sente ${m?"proforma":"facture"} \xe0 la somme de <strong>${(0,s.RQ)(l).replace(/^Arrêté.*?somme de /i,"").replace(" FCFA"," francs CFA")}</strong></div>`:""}
